     ...
     await dispatch(editBlog(
      ...
      toast.success("Blog updated successfully")
        ...
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1 font-sans font-bold">Delete Blog</ModalHeader>
              <ModalBody>
                  <p className='text-lg font-serif' id='delete-blog ' >Are you sure you want to delete this blog</p>
              ...
              <ModalFooter>
                <Button color="danger" variant="light" onPress={onClose}>
                  ...
                  <Button color="primary" type="submit" form="delete-blog" onClick={
                    async () => {
                    onOpenChange(false)
